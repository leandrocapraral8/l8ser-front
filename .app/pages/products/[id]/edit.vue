...
definePageMeta({
  ...
  preview: {
    title: 'Edit product',
    description: 'For creating a product profile',
...
const VALIDATION_TEXT = {
  ...
  CATEGORY_REQUIRED: 'Your category can\'t be empty',
  PRICE_REQUIRED: 'Your price can\'t be empty',
}
...
const zodSchema = z
  .object({
    ...
    product: z.object({
      ...
      category: z.number().min(1, VALIDATION_TEXT.CATEGORY_REQUIRED),
      price: z.number().min(1, VALIDATION_TEXT.PRICE_REQUIRED),
    }),
  })
    ...
    resetForm({
      values: {
        ...
        product: {
          ...
          category: product.value?.product_category_data.id || '',
...
const onSubmit = handleSubmit(
  async (values) => {
    ...
    try {
      const response = await $axios.patch(`/products/${productId}/`, payload, {
        headers: {
    ...
    <BaseCard>
      <div class="flex items-center justify-between p-4">
        ...
        <div class="flex items-center gap-2">
          <BaseButton class="w-24" to="/products/">
            Cancel
          </BaseButton>
          <BaseButton
            color="primary"
              ...
              <div class="col-span-12 sm:col-span-6">
                ...
                >
                  ...
                  >
                    ...
                    <option
                      v-for="(productCategory, productCategoriesIndex) in productCategories"
              ...
              <div class="col-span-12">
                ...
                >
                  <BaseInput
                    ...
                    :disabled="isSubmitting"
                    type="number"
                    icon="material-symbols-light:price-check"
                    placeholder="Price"
                    @update:model-value="handleChange"
                    @blur="handleBlur"
                  />
    ...
    <div class="p-4 md:p-6">
      <div class="mx-auto w-full max-w-xs text-center">
        ...
        <p class="font-alt text-muted-500 dark:text-muted-400 text-sm leading-5">
          Are you sure you want to update the information for product with ID: <strong>{{ productId }}</strong>?
        </p>
      </div>
    </div>
